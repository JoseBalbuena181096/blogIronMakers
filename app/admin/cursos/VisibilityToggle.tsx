...
export default function VisibilityToggle({ cursoId, initialPublicado }: VisibilityToggleProps) {
    ...
    return (
        <div className="flex items-center gap-2">
            <button
                ...
                title={publicado ? 'Público - Visible para todos' : 'Borrador - Solo visible para admins'}
            >
                <span
            ...
            <span className={`text-sm font-medium ${publicado ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-gray-400'}`}>
